...
echo ""
echo "==========================================="
echo "Iniciando VRising Server (DEBUG MODE)"
echo "  Porta:  ${VR_GAME_PORT:-27015}/UDP"
echo "  Query:  ${VR_QUERY_PORT:-27016}/UDP"
echo "  Nome:   ${VR_SERVER_NAME:-VRising-ARM64}"
echo ""
echo "FLAGS APLICADAS:"
echo "  -batchmode         (sem UI)"
echo "  -nographics        (sem renderização)"
echo "  -disableBurstCompilation (AVX compat)"
echo "==========================================="
echo ""

# Cria diretório de settings se não existe
mkdir -p "$DATA_DIR/Settings"

# Executa servidor com flags de compatibilidade
